...
- **Uncertainty Quantification of Pre-Trained and Fine-Tuned Surrogate Models using Conformal Prediction**
  ...
  - TLDR: [Brief summary of the paper]
  - [Paper](https://arxiv.org/abs/2408.09881), [Code](https://github.com/gitvicky/Spatio-Temporal-CP)
...
- **Valid Error Bars for Neural Weather Models using Conformal Prediction**
  ...
  - TLDR: [Brief summary of the paper]
  - [Paper](https://arxiv.org/abs/2406.14483), [Code](https://github.com/gitvicky/neural-lam-CP)
...
- **Plasma surrogate modelling using Fourier neural operators**
  ...
  - TLDR: [Brief summary of the paper]
  - [Paper](https://iopscience.iop.org/article/10.1088/1741-4326/ad313a/meta), [Code](https://github.com/Plasma-FNO)
...
- **Loss landscape engineering via data regulation on PINNs**
  ...
  - TLDR: [Brief summary of the paper]
  - [Paper](https://www.sciencedirect.com/science/article/pii/S2666827023000178), [Code](https://github.com/gitvicky/Loss_Landscape_PINNs)
...
- **Fourier-RNNs for modelling noisy physics data**
  ...
  - TLDR: [Brief summary of the paper]
  - [Paper](https://arxiv.org/abs/2302.06534)
...
- **Image mapping the temporal evolution of edge characteristics in tokamaks using neural networks**
  ...
  - TLDR: [Brief summary of the paper]
  - [Paper](https://iopscience.iop.org/article/10.1088/2632-2153/ab5639/meta)